...
[![build](https://img.shields.io/github/actions/workflow/status/rafaeldepontes/auth-go/build.yml?label=build&logo=githubactions&logoColor=white&labelColor=2F2F2F)](https://github.com/rafaeldepontes/fauthless-go/actions/workflows/build.yml)
[![tests](https://img.shields.io/github/actions/workflow/status/rafaeldepontes/auth-go/tests.yml?label=tests&logo=go&logoColor=white&labelColor=2F2F2F)](https://github.com/rafaeldepontes/fauthless-go/actions/workflows/tests.yml)
